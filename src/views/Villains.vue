...
const { mapActions, mapState } = createNamespacedHelpers('villain');
...
export default {
  ...
  methods: {
    ...
    async loadVillains({ force } = { force: false }) {
      this.message = 'getting the villains, please be patient';
      await this.getVillainsAction({ force });
      this.message = '';
    },
  },
  computed: {
